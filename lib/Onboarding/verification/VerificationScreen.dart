...
class _VerificationScreenState extends State<VerificationScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Get the passed arguments in post-frame callback
  ...
  Future<void> _loadAccentColor() async {
    ...
    if (await globalState.hasColor()) {
      final colorString = globalState.color;
      if (colorString != null) {
        setState(() {
  ...
  Future<void> _verifyCode() async {
    ...
    try {
      ...
      if (response['success'] == true) {
        // If verification is successful, pass all data to setup screen
